...
public class RemoveStudentFromCourseCommand implements Command {
    private static final String DESCRIPTION = "Remove the student from one of his or her courses.";
    private StudentDao studentDao;
    private CourseDao courseDao;

    public RemoveStudentFromCourseCommand(StudentDao studentDao, CourseDao courseDao) {
    ...
    public void doCommand() throws DaoException {
        ...
        System.out.println(student.toString() + " was successfully removed from the course " + course.getName());
    }
}